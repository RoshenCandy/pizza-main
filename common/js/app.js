...
$(window).on('scroll', function (a, b, c) {
  ...
  if (
    ...
    $(window).scrollTop() + headerOffset < $('.drimclub-benefit').outerHeight() + $('.drimclub-benefit').offset().top
  ) {
  ...
  if (
    ...
    $(window).scrollTop() + headerOffset < $('.big-slider').outerHeight() + $('.big-slider').offset().top
  ) {
  ...
  if (
    ...
    $(window).scrollTop() + headerOffset < $('.discounts-block').outerHeight() + $('.discounts-block').offset().top
  ) {
    $('.header').addClass('header--in-white');
  }
  ...
  if (
    ...
    $(window).scrollTop() + headerOffset < $('.recomended-drimclub').outerHeight() + $('.recomended-drimclub').offset().top
  ) {
    $('.header').addClass('header--in-gray');
  }
  ...
  if (
    ...
    $(window).scrollTop() + 350 < $('.discounts-block__audio-courses').outerHeight() + $('.discounts-block__audio-courses').offset().top
  ) {
  ...
  if (
    ...
    $(window).scrollTop() + headerOffset < $('.connect-drimclub').outerHeight() + $('.connect-drimclub').offset().top
  ) {
    $('.header').addClass('header--in-white');
  }
...
function setBigSlide(obj) {
  ...
  $('.big-slider__images ul li').removeClass('active').animate({ opacity: 0 }, 300);
  $('.big-slider__images ul li[data-index="' + sliderIndex + '"]')
    .addClass('active')
